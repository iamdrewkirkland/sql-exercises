--What grades are stored in the database? 1st - 5th
--SELECT * FROM Grade

--What emotions may be associated with a poem? Anger, Fear, Sadness, Joy
--SELECT * FROM Emotion

--How many poems are in the database? 32,842
--SELECT COUNT(*) AS 'Poem Count'
--FROM Poem

--Sort authors alphabetically by name. What are the names of the top 76 authors? Lots of "A" names.
